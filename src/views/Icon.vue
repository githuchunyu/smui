<template>
  <div class="page">
    ...
    <sm-header title="Icon"></sm-header>

    <sm-navbar :list="tabs" v-model="activeIndex"></sm-navbar>
    <div class="tabs">
      <div class="tab" v-if="activeIndex==0">
        <h4>共{{icons.length}}个</h4>
        <div class="items">
          <div class="item" v-for="icon in icons">
            <sm-icon class="item-icon" :name="icon"></sm-icon>
            <span>{{icon}}</span>
          </div>
        </div>
      </div>

      <div class="tab" v-if="activeIndex==1">
        <h4>共{{regulars.length}}个</h4>
        <div class="items">
          <div class="item" v-for="icon in regulars">
            <sm-icon class="item-icon" type="regular" :name="icon"></sm-icon>
            <span>{{icon}}</span>
          </div>
        </div>
      </div>

      <div class="tab" v-if="activeIndex==2">
        <h4>共{{brands.length}}个</h4>
        <div class="items">
          <div class="item" v-for="icon in brands">
            <sm-icon class="item-icon" type="brand" :name="icon"></sm-icon>
            <span>{{icon}}</span>
          </div>
        </div>
      </div>
